...
class User(db.Model):  
    ...
    admin=db.relationship("Admin", back_populates="adminuser")
...
class Admin(db.Model):
    ...
    admin_userid = db.Column(db.Integer, db.ForeignKey('user.user_id', ondelete='CASCADE'), nullable=False)
    admin_username=db.Column(db.String(20),nullable=True)
    admin_pwd=db.Column(db.String(255),nullable=True)

    adminuser=db.relationship("User", back_populates="admin")
